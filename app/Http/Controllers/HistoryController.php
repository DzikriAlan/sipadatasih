...
class HistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('history.index', compact('daftar_permohonan', 'update_terakhir', 'daftar_semua_permohonan', 'daftar_permohonan_disetujui'));
    }
    ...
    public function show(History $permohonan)
    {
        $permohonan_detail = DB::table('permohonan')
            ...
            ->get();
        dd($permohonan);
        return view('history.detail', compact('permohonan', 'permohonan_detail'));
    }

    public function edit(History $permohonan)
    {
        echo $permohonan;
        return view('history.edit', compact('history'));
    }

    public function update(HistoryRequest $request, History $permohonan)
    {
        $input = $request->all();
        // $input['slug_artikel'] = Str::slug($input['judul_artikel'], '-');
        // $input->id_user = Session::get('id');
    ...
    public function destroy(History $permohonan)
    {
        $permohonan->delete();
    ...
    public function validasiPermohonan(History $permohonan)
    {
        // $permohonan->status = 0;
        // $permohonan->save();
    ...
    public function tolak(HistoryRequest $request, History $permohonan)
    {
        $input = $request->all();
        $permohonan->status = 5;
