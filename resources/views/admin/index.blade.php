                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><i class="fa fa-user-secret"></i>&nbsp; ADMIN</strong>
                                <a href="{{ url('admin/create') }}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus fa-lg"></i> </a>
                            </div>
                            <div class="card-body">
                                ...
                                <span class="float-right">
                                    Update Terakhir :
                                    <strong class="font-weight-bold text-capitalize d-inline-block mb-1">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $admin->no_hp }}</td>
                                        <td>
                                            <a href="{{ url('admin/'. $admin->id .'/edit') }}" class="btn btn-success btn-sm"> <i class="fa fa-edit fa-lg"></i> </a>
