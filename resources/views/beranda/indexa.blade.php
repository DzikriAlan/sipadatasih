...
<head>
    <meta charset="utf-8">
    <title>{{ $profil->nama }} &mdash; SIPADATASIH</title>
...
<body>
    ...
    <div class="site-wrap">
                ...
                <div class="container-fluid py-1">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 text-left">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('assets-dashboard/images/' . $profil->logo) }}"
                                    style="margin-top: 10px" width="45" class="d-none d-xl-inline-block">

                                <img src="{{ asset('assets-dashboard/images/' . $profil->logo) }}" width="45"
                                    class="d-inline-block d-xl-none">

                                {{-- <h5 class="ml-2 mt-2 site-logo text-white d-none d-xl-inline-block text-uppercase"
                                    ...
                                    <ul class="site-menu js-clone-nav d-none d-xl-block text-center"> <li class="has-children">
                                            ...
                                            <ul class="dropdown arrow-top">
                                                <li><a href="{{ url('beranda/profil') }}"> <i class="fa fa-info"></i>
                                                        PROFIL</a></li>
                                                <li><a href="{{ url('beranda/tanaman-komoditas') }}"><i
                                                            class="fa fa-leaf"></i> KOMODITAS</a></li>
                                                <li><a href="{{ url('beranda/pelayanan') }}"><i
                                                            class="fa fa-info-circle"></i> PELAYANAN</a></li>
                                                <li><a href="{{ url('beranda/lembaga') }}"><i class="fa fa-bank"></i>
                                                        LEMBAGA</a></li>
                                                ...
                                                <li class="has-children">
                                                    ...
                                                    <ul class="dropdown arrow-top">
                                                        <li><a href="{{ url('beranda/fasilitas-pemukiman') }}"><i
                                                                    class="fa fa-bed"></i> PEMUKIMAN</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-pemerintahan') }}"><i
                                                                    class="fa fa-building"></i> PEMERINTAHAN</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-peribadatan') }}"><i
                                                                    class="fa fa-moon-o"></i> PERIBADATAN</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-kesehatan') }}"><i
                                                                    class="fa fa-heart"></i> KESEHATAN</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-ekonomi') }}"><i
                                                                    class="fa fa-dollar"></i> EKONOMI</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-prasarana') }}"><i
                                                                    class="fa fa-wifi"></i> PRA-SARANA</a></li>
                                                        <li><a href="{{ url('beranda/fasilitas-pendidikan') }}"><i
                                        ...
                                        <!-- <li class="has-children">
                                            ...
                                            <ul class="dropdown arrow-top">
                                                <li><a href="{{ url('beranda/belanja') }}"><i
                                                            class="fa fa-credit-card"></i> BELANJA</a></li>
                                                <li><a href="{{ url('beranda/pendapatan') }}"><i
                                                            class="fa fa-dollar"></i> PENDAPATAN</a></li>
                                            </ul>
                                        </li> -->
                                        <li class="has-children">
                                            <a href="#"><i class="fa fa-users"></i> PENDUDUK</a>
                                            <ul class="dropdown arrow-top">
                                                <li><a href="{{ url('beranda/penduduk-usia') }}"><i
                                                            class="fa fa-calendar"></i> USIA</a></li>
                                                <li><a href="{{ url('beranda/penduduk-pekerjaan') }}"><i
                                                            class="fa fa-car"></i> PEKERJAAN</a></li>
                                                <li><a href="{{ url('beranda/penduduk-pendidikan') }}"><i
                                                            class="fa fa-graduation-cap"></i> PENDIDIKAN</a></li>
                                                <li><a href="{{ url('beranda/penduduk-golongan-darah') }}"><i
                                                            class="fa fa-tint"></i> GOL. DARAH</a></li>
                                                <li><a href="{{ url('beranda/penduduk-menikah') }}"><i
                                                            class="fa fa-female"></i><i class="fa fa-male"></i>
                                                        MENIKAH</a></li>
                                                <li><a href="{{ url('beranda/penduduk-agama') }}"><i
                                                            class="fa fa-moon-o"></i> AGAMA</a></li>
                                                <li><a href="{{ url('beranda/penduduk-jenis-kelamin') }}"> <i
                                                            class="fa fa-male"></i> JENIS KELAMIN</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ url('beranda/artikel') }}"><i class="fa fa-newspaper-o"></i>
                                                ARTIKEL</a></li>
                                        <li><a href="{{ url('beranda/kegiatan') }}"><i class="fa fa-camera"></i>
                                                KEGIATAN</a></li>

                                        @if (Session::has('pengguna'))
                                            <li class="has-children">
                                                <a href="#"><i class="fa fa-user"></i>
                                                    {{ substr(Session::get('nama'), 0, 5) }} </a>
                                                <ul class="dropdown arrow-top">
                                                    <li><a href="{{ url('beranda/dashboard') }}"><i
                                                                class="fa fa-dashboard"></i> PROFIL</a></li>
                                                    <li><a href="{{ url('keluar') }}"><i class="fa fa-sign-out"></i>
                                                            KELUAR</a></li>
                                                </ul>
                                            </li>
                                        @else
                                            <li><a href="{{ url('masuk') }}"><i class="fa fa-sign-in"></i> MASUK</a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
        ...
        <div class="site-blocks-cover overlay"
            style="background-image: url({{ asset('assets-beranda/images/' . $pengaturan->gambar) }});"
            data-aos="fade-up" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center text-center justify-content-center">
                    <div class="col-md-12">
                        <span class="sub-text">SISTEM PELAYANAN ADMINISTRASI DIGITAL TERINTEGRASI</span>
                        <h1 class="text-uppercase"> Kelurahan <br> {{ $profil->nama }} </h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{ url('beranda/profil') }}">
                            <h2 class="font-weight-bold text-black mb-5"><i class="fa fa-eye"></i><i
                                    class="fa fa-eye"></i> VISI MISI</h2>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-3 mb-lg-0 text-center">
                        <div class="media custom-media">
                            <div class="media-body text-center">
                                <img src="{{ asset('assets-beranda/images/lurah-adi.jpg') }}"
                                    class="img img-responsive shadow" width="300">
                                <h4 class="mt-3 font-weight-bold">
                                    Adi Suryana S,STP M,Si
                                </h4>
                                <hr>
                                <h4>
                                    LURAH TELAGA ASIH
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: [
                                        {{ $balita }}, {{ $kanak_kanak }}, {{ $remaja_awal }},
                                        {{ $remaja_akhir }}, {{ $dewasa_awal }}, {{ $dewasa_akhir }},
                                        {{ $lansia_awal }}, {{ $lansia_akhir }}, {{ $manula }}
                                    ],
        ...
        <div class="site-section border" data-aos="zoom-out">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{ url('beranda/artikel') }}">
                            <h2 class="font-weight-bold text-black mb-5"> <i class="fa fa-newspaper-o"></i> ARTIKEL
                            </h2>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 post-entry">
                            <a href="{{ url('beranda/artikel/' . $artikel->slug_artikel) }}" class="d-block figure">
                                ...
                                @if (empty($artikel->gambar_artikel))
                                    <img src="{{ asset('assets-beranda/images/img_2.jpg') }}" alt="Image"
                                        class="img-fluid">
                                @else
                                    <img src="{{ asset('assets-beranda/images/' . $artikel->gambar_artikel) }}"
                            ...
                            <h3><a href="{{ url('beranda/artikel/' . $artikel->slug_artikel) }}">
                                    {{ $artikel->judul_artikel }} </a></h3>
                        </div>
                    @endforeach
                ...
                <div class="row mt-2 text-center">
                    <div class="col-12">
                        <p><a href="{{ url('beranda/artikel') }}" class="btn btn-primary btn-lg rounded-0">Lihat
                                Semua Artikel</a></p>
                    </div>
                </div>
            </div>
        ...
        {{-- <div class="site-section" data-aos="zoom-in">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{ url('beranda/belanja') }}">
                            <h2 class="font-weight-bold text-black mb-5"><i class="fa fa-money"></i> KEUANGAN</h2>
                        </a>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body btn-info">
                                    ...
                                    <div class="d-inline-block mx-2">
                                        <div class="text-left dib">
                                            <h2 class="text-white">Rp.
                                                {{ number_format($total_belanja, 0, ',', '.') }},- </h2>
        ...
        <div class="site-section" data-aos="zoom-in">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <a href="{{ url('beranda/kegiatan') }}">
                            <h2 class="font-weight-bold text-black mb-5"><i class="fa fa-camera"></i> KEGIATAN</h2>
                        </a>
                    </div>
                </div>
                <div class="row mb-5">
                    ...
                    @foreach ($daftar_kegiatan as $kegiatan)
                        <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 post-entry">
                            <a href="{{ url('beranda/kegiatan' . $kegiatan->slug_kegiatan) }}"
                                class="d-block figure">
                                @if (empty($kegiatan->poster_kegiatan))
                                    <img src="{{ asset('assets-dashboard/images/img_2.jpg') }}" alt="Image"
                                        class="img-fluid">
                                @else
                                    <img src="{{ asset('assets-dashboard/images/' . $kegiatan->poster_kegiatan) }}"
                                        alt="Image" class="img-fluid">
                                @endif
                            </a>
                            <span class="text-muted d-block mb-2"> <i class="fa fa-calendar"></i>
                                {{ $kegiatan->created_at->diffForHumans() }} </span>
                            <h3><a href="{{ url('beranda/kegiatan/' . $kegiatan->slug_kegiatan) }}">
                                    {{ $kegiatan->nama_kegiatan }} </a></h3>
                        </div>
                    @endforeach
                ...
                <div class="row mt-5 text-center">
                    <div class="col-12">
                        <p><a href="{{ url('beranda/kegiatan') }}" class="btn btn-primary btn-lg rounded-0">Lihat
                                Semua Kegiatan</a></p>
                    </div>
                </div>
            </div>
        ...
        <footer class="site-footer border-top" data-aos="fade-down">
            <div class="container">
                <div class="row pt-2 text-left">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('assets-dashboard/images/' . $profil->logo) }}" width="100"
                            class="my-2">
                        <p>
                            ...
                            </script> {{ $profil->nama }} <br>
                            SIPADATASIH Dikembangkan oleh <strong> PT Surya Microsystems International, 2022</strong>
                            <br>
                    ...
                    <div class="col-md-6">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15863.925637707394!2d107.09577149999998!3d-6.26617495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698f8b8e93ffcf%3A0x607bc6a91862ffd7!2sTelaga%20Asih%2C%20Cikarang%20Barat%2C%20Bekasi%20Regency%2C%20West%20Java!5e0!3m2!1sen!2sid!4v1656858771224!5m2!1sen!2sid"
                            style="width:100%; height:300px;" frameborder="0" style="border:0"
