...
@section('main-dashboard')
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content" style="">
            ...
            <div class="row">
                <div class="col-12">
                    <h5 class="font-weight-bold mb-2"> <i class="fa fa-file"></i> PERMOHONAN </h5>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <a href="{{ url('permohonan') }}">
                        <div class="card">
                            <div class="card-body">
                                <p class="text-center h5">Permohonan SKD by RW</p>
                                <canvas id="permohonan-by-rw"></canvas>
                            </div>
                        </div>
                    </a>
                </div>
                <script>
                    var ctx = document.getElementById("permohonan-by-rw");
                    ctx.height = 150;
                ...
                <div class="col-lg-6 col-md-6">
                    <a href="{{ url('permohonan') }}">
                        <div class="card">
                            <div class="card-body">
                                <p class="text-center h5">Permohonan SKD by Status</p>
                                <canvas id="permohonan"></canvas>
                            </div>
                        </div>
                    </a>
                </div>
                <script>
                    var ctx = document.getElementById("permohonan");
                    ctx.height = 150;
                    var myChart = new Chart(ctx, {
                        type: 'bar',
                        data: {
                            labels: ['Draft', 'Ditolak', 'Menunggu Verifikasi RT', 'Menunggu Verifikasi RW',
                                'Menunggu Penomoran', 'Menunggu Approval', 'Approved'
                            ],
                            datasets: [{
                                label: "SKD",
                                data: [2, 4, 5, 5, 3, 10, 4],
                ...
                <div class="col-12">
                    <h5 class="font-weight-bold mb-2"> <i class="fa fa-home"></i> TENTANG &nbsp; & &nbsp; <i
                            class="fa fa-bank"></i> PEMERINTAHAN</h5>
                </div>
                ...
                <div class="col-12">
                    <h5 class="font-weight-bold mb-2"> <i class="fa fa-binoculars"></i> FASILITAS, &nbsp; <i
                            class="fa fa-newspaper-o"></i> ARTIKEL &nbsp; & &nbsp; <i class="fa fa-feed"></i> KEGIATAN
                    </h5>
                </div>
                ...
                <div class="col-12">
                    <h5 class="font-weight-bold mb-2"> <i class="fa fa-file-pdf-o"></i> DOKUMEN, &nbsp; <i
                            class="fa fa-info-circle"></i> PELAYANAN, &nbsp; <i class="fa fa-user"></i> PENGGUNA, &nbsp; &
                        &nbsp; <i class="fa fa-user-secret"></i> ADMIN </h5>
                </div>
