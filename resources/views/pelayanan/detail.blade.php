                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('pelayanan/' . $pelayanan->id . '/edit') }}"
                                    class="btn btn-success btn-sm float-right mx-1"> <i class="fa fa-edit fa-lg"></i> </a>
                                <a href="{{ url('pelayanan') }}" class="btn btn-info btn-sm float-right mx-1"> <i
