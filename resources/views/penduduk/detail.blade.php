                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="#" class="btn btn-danger btn-sm float-right mx-1" data-toggle="modal"
                                    data-target="#confirm-delete"><i class="fa fa-trash fa-lg"></i></a>
                                <a href="{{ url('penduduk/' . $penduduk->id . '/edit') }}"
                                    class="btn btn-success btn-sm float-right mx-1"><i class="fa fa-edit fa-lg"></i>
                                </a>
                                <a href="{{ url('penduduk/cetak/' . $penduduk->id) }}"
                                    class="btn btn-warning btn-sm float-right mx-1"><i class="fa fa-print fa-lg"></i></a>
                                <a href="{{ url('penduduk') }}" class="btn btn-info btn-sm float-right mx-1"><i
                                        class="fa fa-arrow-left fa-lg"></i> </a>

                                <div class="modal fade text-danger" id="confirm-delete" tabindex="-1" role="dialog"
                            ...
                            <div class="card-body">
                                        ...
                                        <td class="text-center">
                                            @if (empty($penduduk->foto_penduduk))
                                                <img src="{{ asset('assets-dashboard/images/default.jpg') }}"
                                                    width="300">
                                            @else
                                                <img src="{{ asset('assets-dashboard/images/' . $penduduk->foto_penduduk) }}"
                                                    width="300">
                                            @endif
                                        </td>
                                    </tr>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>KTP</td>
                                        <th> {{ $penduduk->foto_ktp }} </th>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                            @if (empty($penduduk->foto_ktp))
                                                <img src="{{ asset('assets-dashboard/images/default.jpg') }}"
                                                    width="300">
                                            @else
                                                <img src="{{ asset('assets-dashboard/images/' . $penduduk->foto_ktp) }}"
                                                    width="300">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th> {{ $penduduk->foto_kk }} </th>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                            @if (empty($penduduk->foto_kk))
                                                <img src="{{ asset('assets-dashboard/images/default.jpg') }}"
                                                    width="300">
                                            @else
                                                <img src="{{ asset('assets-dashboard/images/' . $penduduk->foto_kk) }}"
                                                    width="300">
                                            @endif
                                        </td>
                                    </tr>
