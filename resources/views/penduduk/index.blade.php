        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                            ...
                            <div class="card-body">
                                <span class="float-left"> Total Data :
                                    <strong class="font-weight-bold d-inline-block mb-1">
                                        {{ number_format($daftar_penduduk->total(), 0, ',', '.') }} </strong>
                                </span>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped">
                                    ...
                                    @foreach ($daftar_penduduk as $penduduk)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('penduduk/' . $penduduk->id) }}"
                                                    class="btn btn-info btn-sm my-1 d-block"><i class="fa fa-eye fa-lg"></i>
                                                </a>
                                                <a href="{{ url('penduduk/' . $penduduk->id . '/edit') }}"
                                                    class="btn btn-success btn-sm my-1 d-block"><i
                                                        class="fa fa-edit fa-lg"></i> </a>
                                                <a href="#" class="btn btn-danger btn-sm my-1 d-block"
                                                    data-toggle="modal"
                                                    data-target="#confirm-delete-{{ $i }}"><i
                                                        class="fa fa-trash fa-lg"></i> </a>

                                                <div class="modal fade text-danger" id="confirm-delete-{{ $i++ }}"
                    ...
                    <!-- <div class="card-body" id="printPreview" style="visibility: hidden">
                        <table id="bootstrap-data-table" class="table table-striped">
                            ...
                            <p style="text-align: center">DAFTAR PENDUDUK</p>
                            <tr>
                                <th>NIK</th>
                                <th>NAMA</th>
                                <th>PEKERJAAN</th>
                            ...
                            @foreach ($daftar_penduduk as $penduduk)
                                <tr>
                                    ...
                                    <td class="text-uppercase">{{ $penduduk->golongan_darah }}</td>
                                    <td class="text-uppercase">{{ $penduduk->agama }}</td>
                                    <td class="text-capitalize text-center">{{ $penduduk->jenis_kelamin }}</td>
                                </tr>
                            @endforeach
                        </table>
                    </div> -->
