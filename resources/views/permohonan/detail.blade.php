                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                @if (Session::has('admin') || Session::has('kasi'))
                                    <a href="{{ url('permohonan/' . $permohonan->id_permohonan . '/edit') }}"
                                        class="btn btn-success btn-sm float-right mx-1"><i class="fa fa-edit fa-lg"></i>
                                    </a>
                                @endif

                                <a href="{{ url('permohonan/tolak/' . $permohonan->id_permohonan) }}"
                                    class="btn btn-success btn-sm float-right mx-1"><i class="fa fa-times"></i>
                                </a>


                                <a href="{{ url('permohonan') }}" class="btn btn-info btn-sm float-right mx-1"> <i
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    {!! Form::open(['url' => 'permohonan/validasi/' . $permohonan->id_permohonan, 'class' => 'd-inline']) !!}
