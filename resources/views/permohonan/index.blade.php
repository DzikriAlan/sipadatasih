            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    @if (Session::has('pengguna') ||
                        Session::has('lurah') ||
                        Session::has('kasi') ||
                        Session::has('ketua_rw') ||
                        Session::has('ketua_rt'))
                        <div class="col-md-12">
                            <div class="card">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-striped">
                                        ...
                                        @foreach ($daftar_permohonan as $permohonan)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('permohonan/' . $permohonan->id_permohonan) }}"
                                                        class="btn btn-info btn-sm d-block my-1"><i
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <strong class="card-title"><i class="fa fa-newspaper-o"></i>&nbsp; PERMOHONAN SIAP
                                        CETAK</strong>
                                    @if (Session::has('pengguna'))
                                        <a href="{{ url('permohonan/create') }}"
                                            class="btn btn-primary btn-sm float-right"> <i class="fa fa-plus fa-lg"></i>
                                        </a>
                                    @endif
                                </div>
                                <div class="card-body">
