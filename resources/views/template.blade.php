...
<head>
    ...
    <title>Dashboard | SIPADATASIH</title>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="menu-title text-left">
                        ...
                        <h4 class="font-weight-bold d-inline-block">SIPADATASIH </h4>
                        <h5 class="font-weight-bold d-inline-block">v. 1</h5>
                        <!-- <small> (2019.6)</small> -->
                    </li>
                    <li class="text-left border-bottom">
                        <h5 class="font-weight-bold d-inline-block">{{ Session::get('nama') }}</h5>
                    </li>
                    @if (Session::has('admin') || Session::has('lurah'))
                        @if (Request::segment(1) === 'dashboard')
                            <li class="active"><a href="{{ url('dashboard') }}"><i
                                        class="menu-icon fa fa-dashboard"></i>DASHBOARD </a></li>
                        @else
                            <li><a href="{{ url('dashboard') }}"><i class="menu-icon fa fa-dashboard"></i> DASHBOARD
                                </a></li>
                        @endif

                        @if (Request::segment(1) === 'profil' ||
                            Request::segment(1) === 'batas' ||
                            Request::segment(1) === 'tanaman-komoditas' ||
                            Request::segment(1) === 'orbitasi' ||
                            Request::segment(1) === 'tipologi' ||
                            Request::segment(1) === 'iklim' ||
                            Request::segment(1) === 'kesuburan-tanah' ||
                            Request::segment(1) === 'penggunaan-tanah' ||
                            Request::segment(1) === 'infrastruktur-melintasi')
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-leaf"></i> <a href="{{ url('tanaman-komoditas') }}">TANAMAN
                                    KOMODITAS</a></li>
                            ...
                            <li><i class="fa fa-square"></i> <a href="{{ url('kesuburan-tanah') }}">KESUBURAN TANAH</a>
                            </li>
                            <li><i class="fa fa-book"></i> <a href="{{ url('penggunaan-tanah') }}">PENGGUNAAN TANAH</a>
                            </li>
                            <li><i class="fa fa-binoculars"></i> <a
                                    href="{{ url('infrastruktur-melintasi') }}">INFRASTRUKTUR</a></li>
                        </ul>
                        </li>
                        ...
                        @if (Request::segment(1) === 'fasilitas-ekonomi' ||
                            Request::segment(1) === 'fasilitas-kesehatan' ||
                            Request::segment(1) === 'fasilitas-pemerintahan' ||
                            Request::segment(1) === 'fasilitas-pemukiman' ||
                            Request::segment(1) === 'fasilitas-pendidikan' ||
                            Request::segment(1) === 'fasilitas-peribadatan' ||
                            Request::segment(1) === 'fasilitas-prasarana')
                            <li class="menu-item-has-children dropdown active">
                            @else
                            <li class="menu-item-has-children dropdown">
                        @endif
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-building"></i><a
                                    href="{{ url('fasilitas-pemerintahan') }}">PEMERINTAHAN</a></li>
                            <li><i class="fa fa-moon-o"></i><a
                                    href="{{ url('fasilitas-peribadatan') }}">PERIBADATAN</a></li>
                            <li><i class="fa fa-heart"></i><a href="{{ url('fasilitas-kesehatan') }}">KESEHATAN</a>
                            </li>
                            <li><i class="fa fa-dollar"></i><a href="{{ url('fasilitas-ekonomi') }}">EKONOMI</a></li>
                            <li><i class="fa fa-wifi"></i><a href="{{ url('fasilitas-prasarana') }}">PRA-SARANA</a>
                            </li>
                            <li><i class="fa fa-book"></i><a href="{{ url('fasilitas-pendidikan') }}">PENDIDIKAN</a>
                            </li>
                        </ul>
                        </li>
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-bar-chart"></i><a
                                    href="{{ url('penduduk/presentasi') }}">PRESENTASI</a></li>
                        </ul>
                        </li>
                    @endif
                    ...
                    @if (Session::has('admin') || Session::has('pengguna'))
                        @if (Request::segment(1) === 'artikel')
                            <li class="active"><a href="{{ url('artikel') }}"><i
                                        class="menu-icon fa fa-newspaper-o"></i>ARTIKEL

                                    @if (Session::has('admin'))
                                        &nbsp;<span class="badge badge-primary">{{ $artikel_invalid->count() }}
                                        </span>
                                    @endif
                    ...
                    @if (Session::has('ketua_rt'))
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-users"></i> <a href="{{ url('penduduk') }}">MASTER</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ url('verifikasi-penduduk') }}">VERIFIKASI</a></li>
                            <li><i class="fa fa-bar-chart"></i><a href="{{ url('penduduk/presentasi') }}">PRESENTASI</a></li>
                        </ul>
                        </li>
                    @endif

                    @if (Session::has('ketua_rw'))
                        @if (Request::segment(1) === 'permohonan')
                    ...
                    @if (Session::has('staff'))
                        ...
                        @endif
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-file-text"></i>PERMOHONAN</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-users"></i><a href="{{ url('permohonan') }}">MASTER</a></li>
                            <li><i class="fa fa-bar-chart"></i><a href="{{ url('permohonan/history') }}">HISTORY</a>
                            </li>
                        </ul>
                        </li>
                        
                        @if (Request::segment(1) === 'kegiatan')
                            <li class="active"><a href="{{ url('kegiatan') }}"><i
                                        class="menu-icon fa fa-camera"></i>KEGIATAN</a></li>
                        @else
                            <li><a href="{{ url('kegiatan') }}"><i class="menu-icon fa fa-camera"></i>KEGIATAN</a>
                            </li>
                        @endif

                        @if (Request::segment(1) === 'dokumen')
                            <li class="active"><a href="{{ url('dokumen') }}"><i
                                        class="menu-icon fa fa-file"></i>DOKUMEN</a></li>
                        @else
                            <li><a href="{{ url('dokumen') }}"><i class="menu-icon fa fa-file"></i>DOKUMEN</a></li>
                        @endif

                        @if (Request::segment(1) === 'pelayanan')
                            <li class="active"><a href="{{ url('pelayanan') }}"><i
                                        class="menu-icon fa fa-info-circle"></i>PELAYANAN</a></li>
                        @else
                            <li><a href="{{ url('pelayanan') }}"><i
                                        class="menu-icon fa fa-info-circle"></i>PELAYANAN</a></li>
                        @endif

                        @if (Request::segment(1) === 'pengguna')
                            <li class="active"><a href="{{ url('pengguna') }}"><i
                                        class="menu-icon fa fa-user"></i>PENGGUNA</a></li>
                        @else
                        ...
                        @if (Request::segment(1) === 'admin')
                            <li class="active"><a href="{{ url('admin') }}"><i
                                        class="menu-icon fa fa-user-secret"></i>ADMIN</a></li>
                        @else
                            <li><a href="{{ url('admin') }}"><i class="menu-icon fa fa-user-secret"></i>ADMIN</a>
                            </li>
                        @endif

                        @if (Request::segment(1) === 'pengaturan')
                            <li class="active"><a href="{{ url('pengaturan') }}"><i
                                        class="menu-icon fa fa-wrench"></i>PENGATURAN</a></li>
                        @else
                            <li><a href="{{ url('pengaturan') }}"><i
                                        class="menu-icon fa fa-wrench"></i>PENGATURAN</a></li>
                        @endif

                    @endif

                    @if (Session::has('admin') || Session::has('kasi') || Session::has('lurah'))
                        ...
                        @if (Session::has('staff'))
                            @if (Request::segment(1) === 'history')
                                <li class="active"><a href="{{ url('history') }}"><i
                                            class="menu-icon fa fa-history"></i>HISTORY</a></li>
                            @else
                                <li><a href="{{ url('history') }}"><i class="menu-icon fa fa-history"></i>HISTORY</a>
                                </li>
                            @endif
                        @endif
